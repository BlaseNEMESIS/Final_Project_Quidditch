...
#Version 0.1 - Create the Harry Class that allows the character to move harry left right and down.
#Gravity affects Harry
...
def game():
    ...
    goodSprites = pygame.sprite.Group(harry)
    #set the fps
